...
Chi Square tests for matched distribution reject the hypergeometric distribution with pvalues < 0.001
---
...
---
### New Visual Inference Testing Method: 

- Combines "Lady Tasting Tea" structure with lineup plot testing

- Explored properties of tea-tasting lineups empirically with survey

- P package implementation is available at [github.com/kmaurer/teaTasteR](https://github.com/kmaurer/teaTasteR)
```{r, eval=FALSE}
